...
class ProjectCategoryUpdatePage extends React.Component {
  static group = "project";
  static keyName = "project.category.update";
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem {...formItemLayout} label="开放">
          {getFieldDecorator("available", {
            ...
            initialValue: source && source.available ? source.available : false,
          })(<Switch/>)}
        </FormItem>
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        // 设置图片的存储路径
        values.iconPath = "/project/category/icon";
        values.backgroundPath = "/project/category/background";

        console.log("Received values of form: ", values);
        request(API.base + API.project.category.update, {
          method: "POST",
          body: values
        })
          .then(res => {
...
const WrappedBookCategoryUpdatePage = Form.create()(ProjectCategoryUpdatePage);
